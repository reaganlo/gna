...
#define GNA_IOCTL_MEM_MAP   CTL_CODE(FILE_DEVICE_PCI_GNA, 0xA00, METHOD_IN_DIRECT, FILE_ANY_ACCESS)
#define GNA_IOCTL_MEM_UNMAP CTL_CODE(FILE_DEVICE_PCI_GNA, 0xA01, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define GNA_IOCTL_CPBLTS    CTL_CODE(FILE_DEVICE_PCI_GNA, 0xA02, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define GNA_IOCTL_NOTIFY    CTL_CODE(FILE_DEVICE_PCI_GNA, 0xA07, METHOD_BUFFERED, FILE_ANY_ACCESS)
