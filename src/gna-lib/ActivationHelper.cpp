...
{
    const auto index = ModelWrapper::GetOperationInfo(apiOperation.Type, ModelWrapper::OperandIndexActivation);
    const auto activation = ModelWrapper::GetOptionalOperand(apiOperation, index, {});
