...
//}
//
//void CopyLayer::validate()
//{
//    Layer::validate();
//
//    Validate::IsMultiplicityOf(cpy->nCopyCols, XNN_N_IN_ELEMS_MPLY);
//    Validate::IsTrue(cpy->nCopyCols < XNN_N_IN_ELEMS_MPLY, XNN_ERR_LYR_CFG);
//    Validate::IsTrue(cpy->nCopyCols > XNN_N_IN_ELEMS_MAX, XNN_ERR_LYR_CFG);
//    Validate::IsTrue(cpy->nCopyRows > lyr->RowCount, XNN_ERR_LYR_CFG);
//}
